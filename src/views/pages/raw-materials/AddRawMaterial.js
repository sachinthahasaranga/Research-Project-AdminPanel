...
const AddRawMaterial = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await apiClient.post('/api/inventory/raw-material/add', formData, { withCredentials: true })

      // Show success alert
      Swal.fire({
        icon: 'success',
        title: 'Raw Material Added!',
        text: 'The new raw material has been successfully added.',
      ...
      Swal.fire({
        icon: 'error',
        title: 'Failed!',
        text: 'An error occurred while adding the raw material.',
