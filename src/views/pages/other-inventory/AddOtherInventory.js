...
const AddOtherInventory = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await apiClient.post('/api/inventory/other/add', formData, { withCredentials: true })
    ...
    <CRow>
      <CCol xs={12} md={12} lg={12} className="mx-auto">
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Add Other Inventory Item</strong>
          </CCardHeader>
          <CCardBody>
...
export default AddOtherInventory
