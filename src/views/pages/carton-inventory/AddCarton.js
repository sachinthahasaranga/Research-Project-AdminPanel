...
const AddCarton = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await apiClient.post('/api/inventory/carton/add', formData, { withCredentials: true })

      // Show success alert
      Swal.fire({
        icon: 'success',
        title: 'Carton Added!',
        text: 'The new carton has been successfully added.',
      ...
      Swal.fire({
        icon: 'error',
        title: 'Failed!',
        text: 'An error occurred while adding the carton.',
